...
Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::AttachModule(ShaderStage stage, const std::vector<char>& src)
{
	if (ShaderModules.contains(stage))
	{
		LOGGER.Error("GraphicsPipeline already contains shader module of this stage: " + std::string(string_VkShaderStageFlagBits((VkShaderStageFlagBits)stage)));
		return *this;
	}
...
Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::DefineInputAssembly(TopologyType _TopologyType)
{
...
Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::SetViewportState(uint32_t _ViewportCount,
...
Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::Raz_SetCullMode(CullingMode _mode)
{
	cullingMode = _mode;
	return *this;
}

Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::Raz_SetLineWidth(float _LineWidth)
{
	LineWidth = _LineWidth;
	return *this;
}

Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::Raz_PolygonMode(PolygonMode _PolygonMode)
{
	polygonMode = _PolygonMode;
	return *this;
}

Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::Raz_DiscardEnable(bool state)
{
	DiscardEnable = state;
	return *this;
}

Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::Raz_DepthClampEnable(bool state)
{
	DepthClampEnable = state;
	return *this;
}

Landmark::Vk::GraphicsPipeline& Landmark::Vk::GraphicsPipeline::SetDepthState(bool _DepthTestingEnable,
